...
if(isset($_POST["paymentMode"])){
	if($_POST["paymentMode"] == "Paypal"){
		header("Location: ../../payment/preapprovalflow.php");
	}
}
	...
	<div class="content-wrap">
		<div id="addgamekey-wrapper">
			<div id="addgamekey">
				...
				<hr>
				<span>Select mode of payment from the list.</span>
			</div>
			...
			<div id ="gamekeybox2">
				<form method="post" action="<?PHP $_SERVER['PHP_SELF'] ?>" >
					<p>Mode of payment:*</p>
						<select name="paymentMode" class="selectpicker">
							<option value="Select">--Select --</option>
						    <option value="Paypal">Paypal</option>
						  </select>
						<span>To add Paypal as a mode of payment, you will need to accept the terms and agreements on the PayPal site.</span>
					<button type ="submit" class="btn btn-primary" id="paymodebutton">ADD MODE OF PAYMENT</button>
				</form>
			</div>
