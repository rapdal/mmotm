...
$cancelUrl = "http://mmo.tm/account/management/settings/payment-method.php";
            // TODO - The landing page on your site where the customer 
            // is sent when they cancel the Preapproval action on PayPal
$returnUrl = "http://mmo.tm/account/management/settings/payment-success.php";
            // TODO - The landing page on your site where the customer 
            // returns to after the Preapproval is agreed to on PayPal
$currencyCode = "USD";
$startingDate = date('Y-m-d\TH:i:s\Z'); // TODO - The datetime when this 
                                       // preapproval agreement starts, 
                                       // cannot be in the past
$endingDate = "2014-01-01T12:00:00Z"; // TODO - The datetime when this 
...
if($ack=="SUCCESS")
{
	$key = urldecode($resArray["preapprovalKey"]);	
	$_SESSION['paypal_key'] = $key;
	
	$cmd = "cmd=_ap-preapproval&preapprovalkey=".$key ;
