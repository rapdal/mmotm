 ...
 ********************************************/
 ...
 //------------------------------------
 $API_UserName = "george_api1.any.tv";
 $API_Password = "NB3HABV3VQU6DZS9";
 $API_Signature = "AFcWxV21C7fd0v3bYYYRCpSSRl31ASH0YvTfbFpdwtnsPLEgdi0Nhqs1";
 ...
 $API_AppID = "APP-8HX20488FR4981324";
 $API_Endpoint = "";
 ...
 */
 ...
 /*
 '---------------------------------------------------------------------------
 ' Purpose: Prepares the parameters for the CancelPreapproval API Call.
 ' Inputs:
 '
 ' Required:
 '
 ...
 '
 ' Returns: 
 '  The NVP Collection object of the CancelPreapproval call response.
 '---------------------------------------------------------------------------
 */
  ...
  */
  ...
  /* Make the Preapproval call to PayPal */
  $resArray = hash_call("CancelPreapproval", $nvpstr);
